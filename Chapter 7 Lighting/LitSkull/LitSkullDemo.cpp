...
void LitSkullApp::DrawScene()
{
	...
	{
	case 1:
		Effects::BasicFX->mObjectConstantBuffer.Data.mLightCount = 1;
		break;
	case 2:
		Effects::BasicFX->mObjectConstantBuffer.Data.mLightCount = 2;
		break;
	case 3:
		Effects::BasicFX->mObjectConstantBuffer.Data.mLightCount = 3;
		break;
	}
	...
	Effects::BasicFX->mFrameConstantBuffer.ApplyChanges(md3dImmediateContext);
	Effects::BasicFX->mObjectConstantBuffer.ApplyChanges(md3dImmediateContext);

	ID3D11Buffer* buffer[2] = { Effects::BasicFX->mObjectConstantBuffer.Buffer(),Effects::BasicFX->mFrameConstantBuffer.Buffer() };
