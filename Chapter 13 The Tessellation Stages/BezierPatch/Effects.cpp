...
void BezierTessellationEffect::SetDirLights(const DirectionalLight* lights)
{
...
void BezierTessellationEffect::ApplyChanges(ID3D11DeviceContext* deviceContext)
{
...
void BezierTessellationEffect::SetEffect(ID3D11DeviceContext* deviceContext)
{
...
void Effects::InitAll(ID3D11Device* device)
{
	...
	BezierTessellationFX = new BezierTessellationEffect(device,
